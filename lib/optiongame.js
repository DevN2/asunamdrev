...
const cekuno = (chatId, lok, game) => {
	if (typeof lok[game] != "object") return false;
	let jawab = lok[game].get(chatId);
	return jawab ? true : false;
};
module.exports = { addSesi, AmbilJawaban, cekStatus, cekWaktu, cekuno, getPosition };
